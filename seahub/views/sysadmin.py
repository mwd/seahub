...
def sys_useradmin_export_excel(request):
    ...
    if is_pro:
        if CALC_SHARE_USAGE:
            head = [_("Email"), _("Status"), _("Role"), _("Space Used"),
                    ...
                    _("Create At"), _("Last Login"), _("Admin"),]
        else:
            head = [_("Email"), _("Status"), _("Role"), _("Space Used"),
                    _("Space Quota"), _("Create At"), _("Last Login"), _("Admin"),]
    else:
        if CALC_SHARE_USAGE:
    ...
    for user in users:
        ...
        create_at = tsstr_sec(user.ctime)
        ...
        if is_pro:
            ...
            if CALC_SHARE_USAGE:
                row = [user.email, status, role, space_usage, space_quota,
                       share_usage, share_quota, create_at, last_login, is_admin]
            else:
                row = [user.email, status, role, space_usage, space_quota,
                       create_at, last_login, is_admin]
